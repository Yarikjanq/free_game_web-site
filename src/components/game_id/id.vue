<template>
  <div class="px-5">
    ...
    <div v-else class="flex mb-10 mt-10 max-[750px]:flex-col">
      ...
      <div class="w-full flex flex-col gap-[10px] bg-[#0E54715E] py-5">
        ...
        <div class="pl-5">
          <h1 class="text-red-500 font-bold text-lg pb-5">
            System requirements
          </h1>
    ...
    <div class="flex gap-7 max-[640px]:flex-col max-[640px]:gap-3">
      <div
        class=""
